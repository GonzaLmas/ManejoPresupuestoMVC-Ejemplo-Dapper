...
namespace ManejoPresupuesto.Servicios
{
    public interface IRepositorioTiposCuentas
    {
        ...
        Task Borrar(int id);
        Task Crear(TipoCuenta pTipoCuenta);
        Task<bool> ExisteRegistro(string nombre, int usuarioId);
        Task<IEnumerable<TipoCuenta>> Obtener(int pUsuarioId);
    ...
    public class RepositorioTiposCuentas : IRepositorioTiposCuentas
    {
        ...
        public async Task<bool> ExisteRegistro(string nombre, int usuarioId)
        {
            using var connection = new SqlConnection(connectionString);
