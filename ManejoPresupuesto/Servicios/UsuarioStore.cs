...
{
    public class UsuarioStore : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore<Usuario> //Implemento Identity para poder manejar el sistema de usuarios
    {
        ...
        //Implemento todas las interfaces de cada repo
